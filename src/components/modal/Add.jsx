...
export default function AddPolicy({ data }) {
    ...
    return (
        <div>
                    ...
                    <div>
                        ...
                        > */}
                            ...
                            <Button disabled variant='contained' type='submit' size="small"
                                sx={{ backgroundColor: 'Green', margin: "4vh -1vw 0vh 1vw" }}>Add</Button>
            ...
            <CardActions>
                <Button onClick={() => setOpen(!open)} variant='contained' sx={{ color: "White" ,marginLeft:'10vw' }}>Add</Button>
            </CardActions>
        </div>
    );
}